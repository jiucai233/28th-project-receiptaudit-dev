...
data_demo_path = Path(__file__).resolve().parents[2] / "data" / "demo"
data_demo_path.mkdir(parents=True, exist_ok=True)
app.mount("/data/demo", StaticFiles(directory=str(data_demo_path)), name="demo_data")
